...
\begin{center}
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=7cm, valign=t]{Bilder/Grafana-Datasource.PNG} % first figure itself
        \captionsetup{justification=centering}
...
\begin{thebibliography}{99}\label{links}
   \bibitem{whyHmac}What is HMAC Authentication and why is it useful?\break \url{https://www.wolfe.id.au/2012/10/20/what-is-hmac-authentication-and-why-is-it-useful/}
    ...
    \bibitem{radioPower}{Design of Wireless Sensors for IoT with Energy
Storage and Communication Channel Heterogeneity\break \url{https://www.mdpi.com/1424-8220/19/15/3364/pdf}}
  \end{thebibliography}
%Index
